...
+ (void)registerForNetworkReachabilityNotifications
{
	[[ReachabilityASI reachabilityForInternetConnection] startNotifier];
...
{
	return ([[ReachabilityASI reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
